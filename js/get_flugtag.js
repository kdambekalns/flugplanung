	...
	$.ajax({
		...
		success: function (data) {
			...
			if (typeof(data) === 'object') {
				...
				var legendRow = $('<tr>');
				legendRow.append('<td colspan="6" style="font-size: small">Abstimmung = <img src="img/stern_fav.svg" class="table-image"></strong> Relevant für die Entscheidung des Haupt-Fluggebiets<br>Piloten maximal = <img src="img/stern_fav.svg" class="table-image"> + <img src="img/stern.svg" class="table-image"> wenn Betrieb nur in diesem Fluggebiet stattfindet<br><span class="badge bg-primary">WF</span> = Hat einen Windenfahrerschein</td>');
